        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left fade-up stagger-2">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              No more searching for different specialists across Gurunanak Colony. From routine checkups to complex digital implants, full-mouth rehabilitation and pediatric care, our implantologist, endodontist, orthodontist and maxillofacial specialists work together within one advanced facility.
            </p>
            ...
            <div className="relative bg-gradient-to-br from-[var(--brand-dark)] to-[var(--brand-darker)] p-6 rounded-[28px] text-white flex items-center justify-between gap-4 depth-stack overflow-hidden">
              ...
              <div className="relative flex-grow text-left ml-4">
                ...
                <p className="text-sm font-medium">1,000+ Happy Patients</p>
              </div>
              ...
              <div className="relative hidden sm:block text-right">
                ...
                <p className="text-sm font-medium">16+ Years</p>
              </div>
            </div>
          </div>
        </div>
