      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <div className="text-left leading-tight">
              <div className="text-lg font-bold text-white">Elite Advanced Dental Clinic</div>
              <div className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--brand-teal)]">Dr. Surya Deep Chaganti</div>
            </div>
          </div>
          <p className="text-gray-300 mb-6 leading-relaxed">
            10 years of trusted implant dentistry in Gurunanak Colony. Dental implants from ₹25,000, Advanced Clear Aligners — Gurunanak Colony&apos;s technology-driven precision dental setup, led by Dr. Surya Deep Chaganti.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center md:text-left mb-12 border-b border-white/5 pb-12">
          <div className="space-y-4">
            ...
            <div className="space-y-2 mt-4">
              ...
              <p className="text-gray-300 font-semibold text-xs">Dr. Surya Deep Chaganti&apos;s Elite Advanced Dental Clinic {branch ? `· ${branch.name}` : ''}</p>
          ...
          <div className="rounded-[28px] overflow-hidden h-[220px] depth-stack border-4 border-white relative group card-3d-tilt">
            ...
            {mapEmbed ? (
              <iframe
                ...
                title={`Elite Advanced Dental Implants and Aligners Clinic - ${branch?.name}`}
        ...
        <div className="border-t border-white/5 mt-12 pt-6 text-center text-gray-500 text-[10px] sm:text-xs">
          <p className="flex items-center justify-center gap-1">
            &copy; {new Date().getFullYear()} Dr. Surya Deep Chaganti&apos;s Elite Advanced Dental Clinic. Made with <span className="text-[var(--accent-pink)]">🤍</span> for beautiful smiles.
          </p>
        </div>
      </div>
    </footer>
